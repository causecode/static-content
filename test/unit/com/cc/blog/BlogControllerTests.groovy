...
class BlogControllerTests {
    ...
    void testListWithoutInstances() {
        ...
        controller.metaClass.userClass = {return "UserClassName"}
        def result = controller.list(2)
        assert result.blogInstanceList.size() == 0
        assert result.blogInstanceTotal == 0
    }
    ...
    void testCreateInvalidParams() {
        ...
        params.author = "Deepa"
        def result=controller.create()
        assert result.blogInstance.lastUpdated == null
    }
    ...
    void testCreateMissingParams() {
        ...
        params.author = "Deepa"
        def result=controller.create()
        assert result.blogInstance.title == null
    }
	...
	void testShowWithOutId() {
		def result=controller.show(null)
		assert response.redirectedUrl == '/blog/list'
	}
    ...
    void testUpdateInvalidVersion() {
        Blog.get(2).version = 2
        Blog.get(2).save()
        params.author="sona"
        params.tags = "Testing, XML, and, JSON, Responses"
