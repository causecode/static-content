...
class PageControllerTests {
    ...
    void testListWithoutPageInstances() {
        Page.get(1).delete()
        Page.get(2).delete()
        Page.get(3).delete()
        Page.get(4).delete()
        ...
        controller.metaClass.userClass = {return "UserClassName"}
        def result = controller.list(2)
        assert result.pageInstanceList.size() == 0
        assert result.pageInstanceTotal == 0
    }
    ...
    void testCreateInvalidData() {
        ...
        params.author = "Deepa"
        def result=controller.create()
        assert result.pageInstance.lastUpdated == null
    }
    ...
    void testCreateMissingData() {
        ...
        params.author = "Deepa"
        def result=controller.create()
        assert result.pageInstance.title == null
    }
