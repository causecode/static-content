	...
	<body>
		...
		<div id="show-content" class="content scaffold-show" role="main">
			...
			<ol class="property-list content">
				...
				<g:if test="${contentInstance?.subTitle}">
				<li class="fieldcontain">
					<span id="subTitle-label" class="property-label"><g:message code="content.subTitle.label" default="Sub Title" /></span>
					
						<span class="property-value" aria-labelledby="subTitle-label"><g:fieldValue bean="${contentInstance}" field="subTitle"/></span>
