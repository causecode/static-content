...
<div class="form-group">
    ...
    <div class=" col-lg-6">
        <g:textField name="${prefix}label" required="" value="${inputWidgetInstance.label}" class="form-control" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class=" col-lg-6">
        <g:textField name="${prefix}name" required="" value="${inputWidgetInstance.name}" class="form-control" />
    </div>
</div>

<div class="form-group widgetKeyValue hide">
    <label class="control-label col-sm-3" for="widgetKeys"> 
        <g:message code="inputWidget.widgetKeys.label" default="Widget Key" />
    </label>
    <div class=" col-lg-6">
        <g:textField name="${prefix}widgetKeys" required="" value="${inputWidgetInstance.widgetKeys}" class="form-control" />
    </div>
</div>

<div class="form-group widgetKeyValue hide">
    <label class="control-label col-sm-3" for="widgetValues"> 
        <g:message code="inputWidget.widgetValues.label" default="Widget Value" />
    </label>
    <div class=" col-lg-6">
        <g:textField name="${prefix}widgetValues" required="" value="${inputWidgetInstance.widgetValues}"
            class="form-control" />
    </div>
</div>

<div class="form-group">
    <label class="control-label col-sm-3" for="defaultValue"> 
...
<div class="form-group">
    <label class="control-label col-sm-3" for="helpType"> 
...
<div class="form-group">
    <label class="control-label col-sm-3" for="helpText"> 
        <g:message code="inputWidget.helpText.label" default="Help Text" />
    </label>
    <div class=" col-lg-6">
        <g:textField name="${prefix}helpText" value="${inputWidgetInstance.helpText}" class="form-control" />
    </div>
</div>

<div class="form-group validation ">
    <label class="control-label col-sm-3" for="validation"> 
...
<div class="form-group defaultSelected hide">
    <label class="control-label col-sm-3 " for="defaultSelected"> 
        <g:message code="inputWidget.defaultSelected.label" default="Default Selected" />
    </label>
    <div class=" col-lg-6">
        <g:textField name="${prefix}defaultSelected" value="${inputWidgetInstance.defaultSelected}" class="form-control"/>
    </div>
</div>

<div class="form-group noSelected hide">
    <label class="control-label col-sm-3" for="noSelected"> 
        <g:message code="inputWidget.noSelected.label" default="No Selected" />
    </label>
    <div class=" col-lg-6">
        <g:textField name="${prefix}noSelected" value="${inputWidgetInstance.noSelected}" class="form-control"/>
    </div>
</div>

<div class="form-group minChar hide">
    <label class="control-label col-sm-3" for="minChar"> 
        <g:message code="inputWidget.minChar.label" default="Min Char" />
    </label>
    <div class="col-sm-3">
        <g:field name="${prefix}minChar" type="number" value="${inputWidgetInstance.minChar}" class="form-control"/>
    </div>
</div>

<div class="form-group maxChar hide">
    <label class="control-label col-sm-3" for="maxChar"> 
        <g:message code="inputWidget.maxChar.label" default="Max Char" />
    </label>
    <div class="col-sm-3">
        <g:field name="${prefix}maxChar" type="number" value="${inputWidgetInstance.maxChar}" class="form-control"/>
    </div>
</div>

<div class="form-group minValueRange hide">
    <label class="control-label col-sm-3" for="minValueRange"> 
        <g:message code="inputWidget.minValueRange.label" default="Min Value Range" />
    </label>
    <div class="col-sm-3">
        <g:field name="${prefix}minValueRange" type="number" value="${inputWidgetInstance.minValueRange}" class="form-control"/>
    </div>
</div>

<div class="form-group maxValueRange hide">
    <label class="control-label col-sm-3" for="maxValueRange"> 
        <g:message code="inputWidget.maxValueRange.label" default="Max Value Range" />
    </label>
    <div class="col-sm-3">
        <g:field name="${prefix}maxValueRange" type="number" value="${inputWidgetInstance.maxValueRange}" class="form-control"/>
    </div>
</div>