    ...
    <table class="table table-bordered table-hover table-striped">
        <thead>
            <tr>
                ...
                <g:sortableColumn property="subTitle" title="${message(code: 'FAQ.subTitle.label', default: 'Sub Title')}" />
        ...
        <tbody>
            <g:each in="${FAQInstanceList}" var="FAQInstance">
                <tr>
                    ...
                    <td><g:link action="show" id="${FAQInstance.id}">${fieldValue(bean: FAQInstance, field: "body")}</g:link></td>
					
                    <td>${fieldValue(bean: FAQInstance, field: "title")}</td>
					
                    <td>${fieldValue(bean: FAQInstance, field: "subTitle")}</td>
					
                    <td>${fieldValue(bean: FAQInstance, field: "author")}</td>
