    ...
    <table class="table table-bordered table-hover table-striped">
        <thead>
            <tr>
                ...
                <g:sortableColumn property="subTitle" title="${message(code: 'news.subTitle.label', default: 'Sub Title')}" />
        ...
        <tbody>
            <g:each in="${newsInstanceList}" var="newsInstance">
                <tr>
                    ...
                    <td><g:link action="show" id="${newsInstance.id}">${fieldValue(bean: newsInstance, field: "body")}</g:link></td>
					
                    <td>${fieldValue(bean: newsInstance, field: "title")}</td>
					
                    <td>${fieldValue(bean: newsInstance, field: "subTitle")}</td>
