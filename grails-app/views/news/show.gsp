...
<body>
    ...
    <ol class="property-list news">
				...
				<li class="fieldcontain">
					<span id="body-label" class="property-label"><g:message code="news.body.label" default="Body" /></span>
					
						<span class="property-value" aria-labelledby="body-label"><g:fieldValue bean="${newsInstance}" field="body"/></span>
				...
				<li class="fieldcontain">
					<span id="subTitle-label" class="property-label"><g:message code="news.subTitle.label" default="Sub Title" /></span>
					
						<span class="property-value" aria-labelledby="subTitle-label"><g:fieldValue bean="${newsInstance}" field="subTitle"/></span>
				...
				<li class="fieldcontain">
					<span id="lastUpdated-label" class="property-label"><g:message code="news.lastUpdated.label" default="Last Updated" /></span>
					
						<span class="property-value" aria-labelledby="lastUpdated-label"><g:formatDate date="${newsInstance?.lastUpdated}" /></span>
				...
				<li class="fieldcontain">
					<span id="publish-label" class="property-label"><g:message code="news.publish.label" default="Publish" /></span>
					
						<span class="property-value" aria-labelledby="publish-label"><g:formatBoolean boolean="${newsInstance?.publish}" /></span>
    ...
    <g:form>
        <fieldset class="form-actions">
            ...
            <g:link class="btn btn-primary" action="edit" id="${newsInstance?.id}">
